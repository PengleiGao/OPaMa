...
parser.add_argument("--image_dir",
                    type=str,
                    default='/mnt/e/Datasets/outdoorPanosPng',
                    required=False)

parser.add_argument("--out_dir",
                    type=str,
                    default='/mnt/e/Datasets/outdoorPanosCaption',
                    required=False)
...
def get_labels(images):
    ...
    if blip_processor is None:
        ...
        blip_processor = BlipProcessor.from_pretrained("/home/gaop/.cache/huggingface/hub/models--Salesforce--blip2-flan-t5-xxl/snapshots/df81189cec360ba04019cfb0802c499224709275")
    if blip_model is None:
        ...
        blip_model = Blip2ForConditionalGeneration.from_pretrained("/home/gaop/.cache/huggingface/hub/models--Salesforce--blip2-flan-t5-xxl/snapshots/df81189cec360ba04019cfb0802c499224709275", torch_dtype=torch.float16, load_in_8bit=True)
