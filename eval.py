...
def compute_sentence_similarity(sen1, sen2):
    ...
    model = SentenceTransformer('/home/kaiser/cache_models/all-mpnet-base-v2')
    scores = dict()
    sum = 0.
...
if __name__ == '__main__':
    os.system('rm -r ./fid_folder/')
    cal_sc=False
    if 1:
        src = '/mnt/e/Datasets/outdoor_with_image/my_project'
        caption_info = 'image_caption/test_new.pkl'
        dest = './fid_folder/'
    else:
        src = '/mnt/e/Datasets/indoor_uncond/my_project'
        caption_info = 'image_caption/indoor_test.pkl'
        dest = './fid_folder/'
